        ...
        return args -> {
            ...
            for (Account account : accountslist) {
                ...
                Transaction transaction = new Transaction(
                    ...
                    faker.date().between(Date.from(account.getAccountOpened().atStartOfDay(ZoneId.systemDefault()).toInstant()), date).toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime(),
